...
#Create plot 4
##Quadrants for the plot 

par(mfrow = c(2,2))

#Filling in plots left to right 
...
legend("topright",col = c("black","red","blue"),lty=c(1,1),lwd=c(1,1), legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),cex=.3)
